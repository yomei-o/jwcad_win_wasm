...
int main(void)
{
    ...
    alike("orig/Test5.jww", "decomp/res/mt.dxf", "decomp/res/mtin.jww",
          "MTEXTs, read back");
    /* and its HATCHes, each of which becomes one solid: a square as a
       closed polyline, the same as four line edges, and a triangle whose
       fourth corner the original leaves at the origin */
    alike("orig/Test5.jww", "decomp/res/hat.dxf", "decomp/res/hatin.jww",
          "hatches, read back");
