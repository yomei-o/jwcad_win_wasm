...
/* 座標ファイル (32895) の ファイル書込: what is picked goes out as lines of
   text.  (ox, oy) is the point everything is measured from -- the same one
   ブロック化 uses, see src/coord.c.  The caller frees *out. */
