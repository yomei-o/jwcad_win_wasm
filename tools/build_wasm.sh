...
EXPORTS=$EXPORTS,_jw_open,_jw_error,_jw_nobj,_jw_zoom,_jw_pan,_jw_fit,_jw_save_dxf,_jw_save_sfc,_jw_save_jwc,_jw_open_dxf,_jw_open_sfc,_jw_open_jwc,_jw_figure,_jw_save_fig,_jw_save_coord
