...
echo "built tests/frame.exe tests/shot.exe tests/jww_test.exe tests/pick_test.exe tests/read_test.exe tests/click_test.exe tests/write_test.exe tests/new_test.exe tests/sel_test.exe tests/layer_test.exe tests/sunpo_test.exe tests/zoku_test.exe tests/moji_test.exe tests/zokusel_test.exe tests/blkmake_test.exe tests/blkedit_test.exe tests/session_test.exe tests/poly_test.exe tests/mentori_test.exe tests/bunkatsu_test.exe tests/nisen_test.exe tests/chushin_test.exe tests/zokuhen_test.exe tests/xform_test.exe tests/dxf_test.exe tests/dxfread_test.exe tests/sfcread_test.exe tests/sfcwrite_test.exe tests/jwcread_test.exe tests/jwcwrite_test.exe tests/block_test.exe tests/menu_test.exe tests/sessen_test.exe tests/sekien_test.exe tests/curve_test.exe tests/hatch_test.exe tests/houraku_test.exe tests/seiri_test.exe"
