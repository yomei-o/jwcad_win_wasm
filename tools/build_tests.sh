...
$CC $CFLAGS -o tests/moji_test.exe    tests/moji_test.c    $COMMON tests/png.c -lm
$CC $CFLAGS -o tests/zokusel_test.exe tests/zokusel_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/zokuhen2_test.exe tests/zokuhen2_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/blkmake_test.exe tests/blkmake_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/blkedit_test.exe tests/blkedit_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/kihon_test.exe tests/kihon_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/jikkaku_test.exe tests/jikkaku_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/sunpodlg_test.exe tests/sunpodlg_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/bairitsu_test.exe tests/bairitsu_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/figure_test.exe tests/figure_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/figreg_test.exe tests/figreg_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/zokattr_test.exe tests/zokattr_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/snap_test.exe tests/snap_test.c tests/png.c $COMMON -lm
$CC $CFLAGS -o tests/coord_test.exe tests/coord_test.c tests/png.c $COMMON -lm
...
$CC $CFLAGS -o tests/sfcwrite_test.exe tests/sfcwrite_test.c $COMMON -lm
$CC $CFLAGS -o tests/jwcread_test.exe tests/jwcread_test.c $COMMON -lm
$CC $CFLAGS -o tests/jwcwrite_test.exe tests/jwcwrite_test.c $COMMON -lm
...
$CC $CFLAGS -o tests/houraku_test.exe tests/houraku_test.c $COMMON -lm
...
$CC $CFLAGS -o tests/fuzz_test.exe  tests/fuzz_test.c  $COMMON -lm
$CC $CFLAGS -o tests/cmdfuzz_test.exe tests/cmdfuzz_test.c $COMMON -lm
$CC $CFLAGS -o tests/seq_test.exe tests/seq_test.c $COMMON -lm
$CC $CFLAGS -o tests/bigcirc_test.exe tests/bigcirc_test.c $COMMON -lm
$CC $CFLAGS -o tests/linewalk_test.exe tests/linewalk_test.c $COMMON -lm
$CC $CFLAGS -o tests/clipwalk_test.exe tests/clipwalk_test.c $COMMON -lm
$CC $CFLAGS -o tests/pickwalk_test.exe tests/pickwalk_test.c $COMMON -lm
echo "built tests/frame.exe tests/shot.exe tests/jww_test.exe tests/jws_test.exe tests/pick_test.exe tests/read_test.exe tests/click_test.exe tests/write_test.exe tests/new_test.exe tests/sel_test.exe tests/layer_test.exe tests/sunpo_test.exe tests/zoku_test.exe tests/moji_test.exe tests/zokusel_test.exe tests/zokuhen2_test.exe tests/blkmake_test.exe tests/blkedit_test.exe tests/kihon_test.exe tests/jikkaku_test.exe tests/sunpodlg_test.exe tests/bairitsu_test.exe tests/figure_test.exe tests/figreg_test.exe tests/zokattr_test.exe tests/snap_test.exe tests/coord_test.exe tests/session_test.exe tests/poly_test.exe tests/mentori_test.exe tests/bunkatsu_test.exe tests/nisen_test.exe tests/chushin_test.exe tests/zokuhen_test.exe tests/xform_test.exe tests/dxf_test.exe tests/dxfread_test.exe tests/sfcread_test.exe tests/sfcwrite_test.exe tests/jwcread_test.exe tests/jwcwrite_test.exe tests/block_test.exe tests/menu_test.exe tests/sessen_test.exe tests/sekien_test.exe tests/curve_test.exe tests/hatch_test.exe tests/fuzz_test.exe tests/cmdfuzz_test.exe tests/seq_test.exe tests/bigcirc_test.exe tests/linewalk_test.exe tests/clipwalk_test.exe tests/pickwalk_test.exe tests/houraku_test.exe tests/seiri_test.exe tests/paper_test.exe"
